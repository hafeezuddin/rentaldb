...
SELECT cm.customer_id, 
    ...
    acs.avg_amount,
    CASE
    WHEN cm.p_total_rentals >= 0.75 AND cm.p_total_spent >= 0.75 THEN 'Frequent High Spenders'
    WHEN cm.p_total_rentals >= 0.75 AND cm.p_total_spent < 0.75 THEN 'Frequent Low Spenders'
    WHEN cm.p_total_rentals < 0.75 AND cm.p_total_spent >= 0.75 THEN 'Occasional High Spenders'
